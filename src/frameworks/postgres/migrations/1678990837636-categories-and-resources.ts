...
export class categoriesAndResources1678990837636 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "Resources" ADD "type" "public"."Resources_type_enum" NOT NULL`,
    );
    await queryRunner.query(`CREATE TYPE "public"."Resources_language_enum" AS ENUM('ru', 'en')`);
    await queryRunner.query(
      `ALTER TABLE "Resources" ADD "language" "public"."Resources_language_enum" NOT NULL`,
    );
    await queryRunner.query(`ALTER TABLE "Resources" ADD "authorId" integer NOT NULL`);
    await queryRunner.query(
      `ALTER TABLE "Categories" ADD "description" character varying NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "Resources" DROP CONSTRAINT "FK_15d8607418778e9c2debba8b4e0"`,
    );
