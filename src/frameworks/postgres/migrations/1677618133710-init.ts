...
export class init1677618133710 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_3c16587f8f4c284467837efc31" ON "ResourceTags" ("resourcesId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_a68896db01d4ea5c8fa3645b65" ON "ResourceTags" ("tagsId") `,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "ResourceTags" DROP CONSTRAINT "FK_a68896db01d4ea5c8fa3645b65b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "ResourceTags" DROP CONSTRAINT "FK_3c16587f8f4c284467837efc310"`,
    );
